...
- the shipped workflow contracts. These pin complete safety-floor and focus-table content, the eleven risk definitions, and the marked test-quality definition. They also cover focus states, per-track design entry, approved area removal, marker availability, conditional Reviewer I composition and separation, no-area model choice, documentation-only classification, all four production defect charters and production-cap classes, split prose and licensing charters, lifecycle ownership, retired-role and prefix absence, and unique named headings across all five workflow documents.
